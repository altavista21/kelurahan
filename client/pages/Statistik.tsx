        ...
        <div className="container mx-auto px-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-4xl font-bold text-purple-600 mt-2">
                    {(
                      parseInt(kelurahanInfo.population.replace(/,/g, "")) /
                      3.25
                    ).toFixed(0)}
                  </p>
                      ...
                      <div key={idx}>
                        ...
                        <div className="w-full bg-slate-300 rounded-full h-3 overflow-hidden">
                          <div
                            ...
                            style={{
                              backgroundColor:
                                statistics.profession.colors[idx],
                    ...
                    <div key={idx + 3}>
                      ...
                      <div className="w-full bg-slate-300 rounded-full h-3 overflow-hidden">
                        <div
                          ...
                          style={{
                            backgroundColor:
                              statistics.profession.colors[idx + 3],
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-8">
            ...
            <p className="text-slate-700">
              Data statistik di atas diperbarui secara berkala berdasarkan data
              terbaru dari Badan Pusat Statistik (BPS) dan pencatatan lokal
              Kelurahan
              {kelurahanInfo.name}. Untuk informasi lebih detail dan terbaru,
              silakan menghubungi kantor kelurahan.
            </p>
          </div>
        </div>
      </section>
